defmodule ElixirGoogleDriveApi.DriveTest do
  ...
  describe "update_permission_file" do
    ...
    @body "{\n \"kind\": \"drive#permission\",\n \"etag\": \"\\\"rOX0fJzgyZU36BYOEcGKIYxPCtI/WYANCZ0UohBR0ORDBV2s-qumiio\\\"\",\n \"id\": \"anyoneWithLink\",\n \"selfLink\": \"https://www.googleapis.com/drive/v3/files/12BbXrA627UzddYJWK3qww1yvWl_aKuvEeSv-qkPtz68/permissions/anyoneWithLink\",\n \"role\": \"writer\",\n \"type\": \"anyone\",\n \"withLink\": true\n}\n"
    @response_body {:ok, %HTTPoison.Response{body: @body}}
  ...
  describe "share_file_with_link" do
    ...
    @request_body %{
      ...
      |> Poison.encode!
    @body "{\"withLink\":true,\"type\":\"anyone\",\"selfLink\":\"https://www.googleapis.com/drive/v3/files/1OLrp44QxZkIQzp4pjxUlsgANqzGGcVGQ7UCKKYWHIWs/permissions/anyoneWithLink\",\"role\":\"writer\",\"kind\":\"drive#permission\",\"id\":\"anyoneWithLink\",\"etag\":\"\\\"rOX0fJzgyZU36BYOEcGKIYxPCtI/_m1PdHgICp2fFXSJzBuz5he_bzI\\\"\"}"
    @response_body {:ok, %HTTPoison.Response{body: @body}}
